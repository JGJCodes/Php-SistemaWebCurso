<?php
/**
 * Archivo que contiene la clase Ventas
...
//método para seleccionar todos los registros
  ...
  //método para mostrar los datos de un registro a modificar
    ...
    //metodo para ver el detalle del cliente en una venta
    public function get_detalle_cliente($numero_venta){
        $conectar=parent::conexion();  
        parent::set_names();
  
        $sql="select v.fecha_venta,v.numero_venta, v.cliente, 
              v.cedula_cliente,v.total,c.id_cliente,c.cedula_cliente,
              c.nombre_cliente, c.apellido_cliente,c.telefono_cliente,
              c.correo_cliente,c.direccion_cliente,c.fecha_ingreso,c.estado
		      from ventas as v, clientes as c
		      where v.cedula_cliente=c.cedula_cliente and v.numero_venta=?; ";
    ...
    //metodo para ver el detalle de una venta
    public function get_detalle_ventas_cliente($numero_venta){
        $conectar=parent::conexion();
        parent::set_names();
  
        $sql="select d.numero_venta,d.cedula_cliente,d.producto, 
              d.moneda,d.precio_venta,d.cantidad_venta,d.descuento,
              d.importe,d.fecha_venta,v.numero_venta, v.moneda,v.subtotal,
               v.total_iva,v.total,c.id_cliente,c.cedula_cliente,
               c.nombre_cliente,c.apellido_cliente,c.telefono_cliente,
               c.correo_cliente,c.direccion_cliente,c.fecha_ingreso,c.estado
              from detalle_ventas as d, ventas as v, clientes as c
             where d.numero_venta = v.numero_venta and 
             d.cedula_cliente = c.cedula_cliente and d.numero_venta=?;";
        ...
        foreach($resultado as $row){
          $html.="<tr class='filas'><td>".$row['cantidad_venta'].
                "</td><td>".$row['producto']."</td> <td>".$row["moneda"].
                " ".$row['precio_venta']."</td> <td>".$row['descuento'].
    ...
    public function numero_venta(){
      ...
      lo recorro que es el campo numero_venta**/
		    foreach($resultado as $k=>$v){
		        $numero_compra["numero"]=$v["numero_venta"];     
		             }
  ...
  public function agrega_detalle_venta(){  
      ...
      parent::set_names();
       ...
       // $sql="insert into detalle_venta
        values(null,'".$numero_venta."','".$producto."','".$precio."','".
        $cantidad."','".$dscto."','".$cedula_proveedor."','".$fecha_venta.
        "','".$estado."');";
        //echo $sql;
         fecha 
          $fecha_compra= date("d/m/Y");
         //estado 
        //si estado es igual a 1 entonces la venta esta pagada
         //$estado = 1;*/
        ...
        necesita para relacionar las tablas compras con detalle_ventas
         para cuando se vaya a hacer la consulta de la existencia del
          producto y del stock para cuando se elimine un detalle venta
       ...
       /*print_r($_POST);
        ...
        $resultado=$sql->fetch(PDO::ASSOC);
          $sql2="insert into ventas 
           values(null,'".$fecha_venta."','".$numero_venta."','".$cliente.
           "','".$cedula_cliente."','".$total."');";
      ...
      //REALIZO EL CALCULO A REGISTRAR
        ...
        /*IMPORTANTE: hay que sacar la consulta INSERT INTO VENTAS
         fuera del foreach sino se repetiria el registro en la tabla ventas
	      fecha 
        estado 
        si estado es igual a 1 entonces la venta esta pagada
			$estado = 1;
