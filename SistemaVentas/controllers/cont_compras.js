 ...
 * la informacion transmitida a la vista Compras
 */
...
$(document).on('click', '.detalle', function () {
    ...
    $.ajax({
        url: "../ajax/compras.php?op=detalle_proveedor",
        method: "POST",
        ...
        success: function (data) {
            ...
            /**puse el alert para ver el error, sin necesidad 
             * de hacer echo en la consulta ni nada
            //alert(data);**/
...
$(document).on('click', '.detalle', function () {
    ...
    $.ajax({
        url: "../ajax/compras.php?op=detalle_compra",
        method: "POST",
        data: { numero_compra: numero_compra },
        cache: false,
        //dataType:"json",
...
$(document).on("click", "#btn_compra_fecha", function () {
    ...
    if (fecha_inicial != "" && fecha_final != "") {
        ...
        tabla_compras = $('#compras_fecha_data').DataTable({
            "aProcessing": true,//Activamos el procesamiento del datatables
            "aServerSide": true,//Paginación y filtrado realizados por el servidor
            dom: 'Bfrtip',//Definimos los elementos del control de tabla
            buttons: [
...
$(document).on("click", "#btn_compra_fecha_mes", function () {
    ...
    if (mes != "" && ano != "") {
        // BUSCA LAS COMPRAS POR FECHA
        var tabla_mes = $('#compras_fecha_mes_data').DataTable({
            "aProcessing": true,//Activamos el procesamiento del datatables
            "aServerSide": true,//Paginación y filtrado realizados por el servidor
            dom: 'Bfrtip',//Definimos los elementos del control de tabla
            buttons: [
