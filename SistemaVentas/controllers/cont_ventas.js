 ...
 * la informacion transmitida a la vista Ventas
 */
...
$(document).on('click', '.detalle', function () {
    ...
    $.ajax({
        url: "../ajax/ventas.php?op=detalle_cliente",
        method: "POST",
...
$(document).on('click', '.detalle', function () {
    ...
    $.ajax({
        url: "../ajax/ventas.php?op=detalle_venta",
        method: "POST",
        data: { numero_venta: numero_venta },
        cache: false,
        //dataType:"json",
...
$(document).on("click", "#btn_venta_fecha_mes", function () {
    ...
    if (mes != "" && ano != "") {
        // BUSCA LAS ventAS POR FECHA
        var tabla_mes = $('#ventas_fecha_mes_data').DataTable({
            "aProcessing": true,//Activamos el procesamiento del datatables
            "aServerSide": true,//Paginación y filtrado realizados por el servidor
            dom: 'Bfrtip',//Definimos los elementos del control de tabla
            buttons: [
