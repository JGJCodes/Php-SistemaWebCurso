                  ...
                  <div class="box">
                    <div class="box-header with-border">
                          <h1 class="box-title">
                            ...
                            onclick="limpiar()" data-toggle="modal" data-target="#clienteModal">
                            <i class="fa fa-plus" aria-hidden="true"></i> Nuevo Cliente</button></h1>
    ...
    <form class="form-horizontal" method="post" id="cliente_form">
      <div class="modal-content">
              ...
              <div class="form-group">
               ...
               <div class="form-group">
                ...
                <div class="form-group">
                 ...
                 <div class="col-lg-9 col-lg-offset-1">
                 <textarea class="form-control  col-lg-5" rows="3" id="direccion" 
        ...
        <div class="modal-footer">
          ...
          <button type="submit" name="action" id="#" class="btn btn-success pull-left" 
...
<script text="text/javascript" src="../cotrollers/cont_cliente.js"></script>
