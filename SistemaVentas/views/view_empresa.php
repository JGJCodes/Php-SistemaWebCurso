<!--
  ...
  de edicion del perfil de empresa
-->

<div id="resultados_ajax" class="text-center"></div>


 <!--FORMULARIO PERFIL EMPRESA MODAL-->
...
<div id="empresaModal" class="modal fade">
        ...
        <div class="modal-body">
               ...
               <div class="form-group">
                  ...
                  <div class="col-lg-9 col-lg-offset-1">
                    <input type="text" class="form-control" id="cedula_empresa" name="cedula_empresa" 
              ...
              <div class="form-group">
               ...
               <div class="form-group">
                ...
                <div class="form-group">
                 ...
                 <div class="col-lg-9 col-lg-offset-1">
                 <textarea class="form-control  col-lg-5" rows="3" id="direccion_empresa" name="direccion_empresa" 
 ...
 <!--FIN FORMULARIO PERFIL EMPRESA MODAL-->
