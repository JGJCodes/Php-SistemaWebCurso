...
?>
                ...
                <!--IMPORTANTE PONER EL ID de data-target="#modalProveedor" debe ser DIFERENTE
                 ...
                 sea unico y diferente en todas las ventanas modales-->
                  <div class="col-lg-6 col-lg-offset-3">
                    ...
                    data-target="#modalProveedor"><i class="fa fa-search" aria-hidden="true">
                    </i>  Buscar Proveedor</button>
                  </div>
        ...
        <div class="col-xs-12">
          <div class="table-responsive">
            <div class="box-body">
              <table id="resultados_footer" class="table table-striped">
                ...
                <tr class="row bg-gray">
                  ...
                  <input type="hidden" name="subtotal_compra" id="subtotal_compra"></td>
            ...
            <td class="col-lg-4">
              ...
              <input type="hidden" name="total_compra" id="total_compra"></td>
                   <!--<td></td>-->
               ...
               <div class="boton_registrar">
                ...
                <i class="fa fa-save" aria-hidden="true"></i>  Registrar Compra</button>
              </div>
  ...
  <!--FIN DE CONTENIDO-->
    ...
    <?php require_once("view_compras_proveedores.php");?>
    <!--VISTA MODAL PARA AGREGAR PROVEEDOR-->
    
     <!--VISTA MODAL PARA AGREGAR PRODUCTO-->
    <?php require_once("view_compras_productos.php");?>
