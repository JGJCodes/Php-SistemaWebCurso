                  ...
                  <div class="box">
                    <div class="box-header with-border">
                          <h1 class="box-title">
                            ...
                            <i class="fa fa-plus" aria-hidden="true"></i> Nuevo Proveedor</button></h1>
...
<div id="proveedorModal" class="modal fade">
  <div class="modal-dialog tamanoModal">
    <form class="form-horizontal" method="post" id="proveedor_form" enctype="multipart/form-data">
      ...
      <div class="modal-header">
           ...
           <div class="form-group">
               ...
               <div class="form-group">
                ...
                <div class="form-group">
                 ...
                 <div class="col-lg-9 col-lg-offset-1">
                 <textarea class="form-control  col-lg-5" rows="3" id="direccion" name="direccion" 
                  placeholder="Direccion ..." required pattern="^[a-zA-Z0-9_áéíóúñ°\s]{0,200}$"></textarea>
                 </div>
              </div>
        ...
        <div class="modal-footer">
          ...
          <button type="submit" name="action" id="#" class="btn btn-success pull-left" value="Add">
...
<script type="text/javascript" src="../controllers/cont_proveedor.js"></script>
