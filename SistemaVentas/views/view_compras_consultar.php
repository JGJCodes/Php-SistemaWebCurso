     ...
     <div class="panel panel-default">  
        <div class="panel-body">
         <div class="btn-group text-center">
          <a href="view_compras.php" id="add_button" class="btn btn-primary btn-lg" >
              <i class="fa fa-plus" aria-hidden="true"></i> Nueva Compra</a>
         </div>
       </div>
      </div>

    <!--VISTA MODAL PARA VER DETALLE COMPRA EN VISTA MODAL-->
     <?php require_once("view_compras_detalle.php");?>
...
<?php require_once("view_footer.php");?>   
  ...
  <!--AJAX COMPRAS-->
<script type="text/javascript" src="../controllers/cont_compras.js"></script>
